...
function applyPreviewUrl($link, url) {
    ...
    // trico edit 2014.07.31 ah - We don't want our thumbnails
    // going to the preview; keep them going to the record page.
    // NOTE: this may become a configurable option; if so,
    // hopefully we can stop hosting this file in our local theme.
